...
GMAIL_UNLOCAL_CHATS = [ ]   # unlocalised Chats names
...
chat_folder=[ u'[Google Mail]/Chats', u'[Gmail]/Chats' ]
...
gmvault_client_id={{ credentials.google_client_id }}
gmvault_client_secret={{ credentials.google_secret }}
